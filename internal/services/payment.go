...
func NewPaymentSrv(orderRepo repository.OrderRepository, paymentRepo repository.PaymentRepository) PaymentService {
	return &paymentService{orderRepo: orderRepo, paymentRepo: paymentRepo}
}
